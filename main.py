...
class TradingBot:
    ...
    def __init__(self):
        self.api_key = os.environ.get('sZU8MFl0EsmffpDQM4zuUIiicAD9yQ7vvrJvR9wkYblgtAJDDailcsZwkvK90UQY')
        self.api_secret = os.environ.get('7kWjxOFTIHrDUju4VoLDCAP93c3zWFhG3799SEBxUTg88NcBESY9WHjob7xChRXz')
        self.telegram_token = os.environ.get('7298814504:AAGdY87w1X4KQwon1WXnGU__QB6ePLNdCIA')
        self.telegram_chat_id = os.environ.get('745231179')
